...
import "./Teams.css";
import { creativeCellData } from "./TeamsData/Creative";
...
export default function Creative() {
    ...
    const [data, setTeamData] = useState(creativeCellData);
    const [activeTN, setActiveTN] = useState("Creative");
    ...
    return (
        <div className="TeamsPage">
            <div className="Team-body">
                ...
                <LeftBar name1="Creative" name2="MEMBERS" />
                </div>

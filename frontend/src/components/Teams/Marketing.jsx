...
import { marketingCommitteeData } from "./TeamsData/Marketing";
...
export default function Marketing() {
    ...
    const [data, setTeamData] = useState(marketingCommitteeData);
    const [activeTN, setActiveTN] = useState("Marketing");
    ...
    return (
        <div className="TeamsPage">
            <div className="Team-body">
                ...
                <LeftBar name1="Marketing" name2="MEMBERS" />
                </div>
